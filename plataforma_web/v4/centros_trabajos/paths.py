...
from .schemas import CentroTrabajoListOut, CentroTrabajoOut, OneCentroTrabajoOut

centros_trabajos = APIRouter(prefix="/v4/centros_trabajos", tags=["funcionarios"])


@centros_trabajos.get("", response_model=CustomPage[CentroTrabajoOut])
async def paginado_centros_trabajos(
    ...
    """Paginado de centros de trabajos"""
...
@centros_trabajos.get("/listado", response_model=CustomList[CentroTrabajoListOut])
