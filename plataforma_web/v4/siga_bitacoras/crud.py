...
def get_siga_bitacoras(
    ...
    consulta = database.query(SIGABitacora)
...
def get_siga_bitacora(database: Session, siga_bitacora_id: int) -> SIGABitacora:
    """Consultar un bitacora por su id"""
    siga_bitacora = database.query(SIGABitacora).get(siga_bitacora_id)
