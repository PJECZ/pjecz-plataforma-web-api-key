...
async def paginado_siga_grabaciones(
...
async def detalle_siga_grabacion_con_archivo_nombre(
    ...
    return OneSIGAGrabacionOut.model_validate(siga_grabacion)
...
async def crear_siga_grabacion(
    ...
    try:
        ...
        return OneSIGAGrabacionOut(success=False, message=str(error))
    respuesta = OneSIGAGrabacionOut.model_validate(siga_grabacion)
